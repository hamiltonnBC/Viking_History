...
export const TIMELINE_ENTRIES: TimelineEntry[] = [
  ...
  },
  {
    ...
    body: 'A wedding ceremony at the church of Hvalsey is the final written record of the Norse population in Greenland. Within decades the settlements had completely vanished. Whether this was from climate deterioration, the Black Death, economic isolation, or conflict with the Inuit remains heavily debated, but it firmly marks the true end of the Viking world.',
    source: 'The Age of the Vikings, Chapter 3',
